...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Models.Satellite>().HasData(
            new Models.Satellite { Id = 1, Name = "Hubble", LaunchDate = new DateTime(1990, 4, 24).ToUniversalTime(), OrbitType = "LEO" },
            new Models.Satellite { Id = 2, Name = "Starlink-17", LaunchDate = new DateTime(2023, 8, 14).ToUniversalTime(), OrbitType = "MEO" },
            new Models.Satellite { Id = 3, Name = "Sentinel-6", LaunchDate = new DateTime(2020, 11, 21).ToUniversalTime(), OrbitType = "LEO" }
        );
